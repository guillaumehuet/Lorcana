...
- [3. Troisième partie – Formalisation de règles](#3.)
    ...
    - [8) Définir "dernière information connue"](#3.8.)
...
Alors… que signifie « recvoir des dommages » ? C’est nouveau aussi ! « Recevoir des dommages » signifie recevoir des marqueurs de dommages de toutes les façons possibles : infliger des dommages, placer des marqueurs de dégâts et les déplacer. Absolument tout ! Vous pouvez maintenant déclencher cette vieille La *Bête – Implacable* avec *Malin, Méchant, Villain* !
...
Le CRD 2.0 modifie plusieurs capacités qui fonctionnaient auparavant par le biais d'effets de remplacement ; elles fonctionnent désormais comme des capacités statiques. Cela concerne notamment Résistance, les effets « sautez » et les effets d'« entrée en jeu ». La plus notable est Résistance, qui est maintenant classée comme un « effet de réduction des dommages ».
...
Notez que cela ne s'applique qu'à cette construction de phrase précise. En revanche, dans *Je voudrais un bonhomme de neige*, le joueur choisit simplement entre D'ACCORD ! et NON !, plutôt que directement les effets. Ce choix se rapproche davantage d'une capacité à choix multiple comme pour *Simba – Prince combatif*.
...
Heureusement, les capacités de début de tour sont désormais directement placées dans le sac lorsqu'elles se déclenchent. Fini les attentes embarrassantes pendant que les joueurs gagnent le lore des lieux.
...
>NdT : YZMA était précédemment le nom informel donné à ce "quelque part" en l'assimilant à une zone. YZMA signifie "Your Zone Managing Actions", soit "Votre zone qui s'occupe des actions".
